...
module.exports = (api, options) => {
    api.chainWebpack(webpackConfig => {
        ...
        const publicDir = api.resolve('public/' + process.env.npm_config_dir)
        const commonDir = api.resolve('public/common');
        console.log(commonDir,outputDir)
